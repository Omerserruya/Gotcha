          ...
          <div className="p-3">
            <div className="bg-white rounded-2xl ring-1 ring-gray-100 shadow-sm p-3">
              ...
              <div className="flex items-center gap-1 mt-2.5">
                ...
                {/* Webchat filter */}
                <button
                  onClick={() => { setChannelFilter(channelFilter === "WEBCHAT" ? "ALL" : "WEBCHAT"); setPage(1); }}
                  title="Web Chat"
                  className={clsx(
                    "w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-all",
                ...
                {customerGroups.map((group) => (
                  <button
                    ...
                    onContextMenu={(e) => {
                      ...
                      if (latestConv) handleContextMenu(e, latestConv.id);
                    }}
                    className={clsx(
              ...
              <div className="bg-white border-b border-gray-100 px-5 py-3 flex items-center gap-3 shadow-sm">
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  >
                    ...
                    {showReplay ? t("history.hideReplay") : t("history.aiReplay")}
                  </button>
                </div>
              </div>
              ...
              <div className="flex-1 flex overflow-hidden">
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className={clsx(
                          ...
                          {conv.status === "OPEN" ? t("conversations.filterOpen") : conv.status === "WAITING" ? t("conversations.filterWaiting") : t("conversations.filterClosed")}
                        </span>
                      </div>
                      <p className="text-xs text-gray-600 truncate">{conv.lastMessageBody || t("history.noMessages")}</p>
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                  {messagesLoading ? (
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-1 bg-[var(--bg-chat)]">
                      {selectedConvId && (
