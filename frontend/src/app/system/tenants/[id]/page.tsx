          ...
          {showAddUser && (
            <form onSubmit={handleAddUser} className="mb-4 p-4 rounded-xl bg-gray-50 border border-gray-200 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <input type="password" value={newUserPassword} onChange={(e) => setNewUserPassword(e.target.value)} required minLength={8} placeholder="Password (min 8)" className="text-sm border border-gray-200 rounded-lg px-3 py-2 bg-white" />
