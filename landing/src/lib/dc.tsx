/**
 * Faithful re-implementation of the four dc-runtime behaviours the generated
 * template depends on. Each function mirrors the corresponding function in the
 * design project's `support.js`, so the rendered DOM matches the design canvas
 ...
 * runtime does, and the design's inline styles are written to suit it.
 * Cached because the generated template calls this on every render.
 */
